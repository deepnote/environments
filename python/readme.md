...
-  [`3.10`, `3.11`, `3.12`, `3.13`, `3.14`](https://github.com/deepnote/environments/tree/main/python/python)
-  [`3.10-datascience`, `3.11-datascience`, `3.12-datascience`, `3.13-datascience`, `3.14-datascience`](https://github.com/deepnote/environments/blob/main/python/datascience/Dockerfile.datascience)

The Python 3.14 datascience image uses the PyTorch backend for Keras and does not include TensorFlow.
